...
const boxesColor = () => `rgb(${randomNumber()}, ${randomNumber()}, ${randomNumber()})`;
...
const createBoxes = (amount) => {
    ...
    for (let i = 0; i < amount; i += 1) {
        ...
        box.style.width = i * 10 + size;
        box.style.height = i * 10 + size;
...
const buttonRenderClick = () => createBoxes(boxAmount.value);
